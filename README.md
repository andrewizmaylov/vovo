...
#### Данный репозиторий - доработанная реализация ТЗ [на вакансию](https://hh.ru/employer/5262091?hhtmFrom=vacancy) от компании VOVO 
...
В сидере создается 100_000 записей, при необходимости эту цифру можно изменить в файле `DatabaseSeeder`
